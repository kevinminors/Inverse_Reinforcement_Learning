...
RAW_DATA_PATH = 'C:/Users/medkmin/highD-dataset-v1.0/data/Track_Data'           # path to raw data files
META_DATA_PATH = 'C:/Users/medkmin/highD-dataset-v1.0/data/Track_Meta_Data'     # path to meta data files
STATE_BIN_MAXIMUM = 3600                                                        # maximum value for state bins
